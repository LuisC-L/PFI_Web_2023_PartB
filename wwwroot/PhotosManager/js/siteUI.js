...
function Init_UI() {
    ...
    if (user && isVerified()) renderPhotos();
    else if (user && !isVerified()) renderVerify();
    ...
    // if (loggedUser && isVerified()) renderPhotos();
    // else renderLoginForm();
}
...
async function renderPhotosList() {
    ...
    try {
        ...
        $(".LikeContainer").hide();  // Move outside the loop
        $("#content").append(`</div>`);
    } catch (error) {
